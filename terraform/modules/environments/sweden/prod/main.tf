...
module "cloudwatch" {
  ...
  instance_ids = [
    ...
    module.database_replica_sweden.replica_instance_ids[0],
  ]
...
module "monitoring" {
  ...
  monitored_instances = [
    ...
    { name = "db-replica", private_ip = module.database_replica_sweden.replica_instance_private_ips[0] },
  ]

  app_security_group_ids = [
    module.app_instance_1.security_group_id,
    module.app_instance_2.security_group_id,
    module.database_replica_sweden.security_group_id,
  ]
}
